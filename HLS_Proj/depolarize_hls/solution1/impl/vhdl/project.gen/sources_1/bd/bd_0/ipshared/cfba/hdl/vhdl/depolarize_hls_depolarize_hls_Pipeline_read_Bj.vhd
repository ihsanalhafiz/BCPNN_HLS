...
entity depolarize_hls_depolarize_hls_Pipeline_read_Bj is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of depolarize_hls_depolarize_hls_Pipeline_read_Bj is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln511_fu_94_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_condition_exit_pp0_iter0_stage0 : STD_LOGIC;
    signal ap_loop_exit_ready : STD_LOGIC;
    signal ap_ready_int : STD_LOGIC;
    signal gmem_blk_n_R : STD_LOGIC;
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal Bj_stream_blk_n : STD_LOGIC;
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal gmem_addr_read_reg_133 : STD_LOGIC_VECTOR (31 downto 0);
    signal j_1_fu_54 : STD_LOGIC_VECTOR (30 downto 0) := "0000000000000000000000000000000";
    signal add_ln511_fu_100_p2 : STD_LOGIC_VECTOR (30 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln511_fu_94_p2 = ap_const_lv1_0))) then 
                    j_1_fu_54 <= add_ln511_fu_100_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    j_1_fu_54 <= ap_const_lv31_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    Bj_stream_blk_n_assign_proc : process(ap_enable_reg_pp0_iter2, Bj_stream_full_n, ap_block_pp0_stage0)
    begin
        if (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
            Bj_stream_blk_n <= Bj_stream_full_n;
        else 
            Bj_stream_blk_n <= ap_const_logic_1;
        end if; 
    end process;

    Bj_stream_din <= gmem_addr_read_reg_133;

    Bj_stream_write_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001)
    begin
        if (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
            Bj_stream_write <= ap_const_logic_1;
        else 
            Bj_stream_write <= ap_const_logic_0;
        end if; 
    end process;

    add_ln511_fu_100_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_j) + unsigned(ap_const_lv31_1));
    ...
    ap_block_state3_pp0_stage0_iter2_assign_proc : process(Bj_stream_full_n)
    begin
                ap_block_state3_pp0_stage0_iter2 <= (ap_const_logic_0 = Bj_stream_full_n);
    end process;


    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln511_fu_94_p2)
    begin
        if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln511_fu_94_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone))) then 
    ...
    ap_sig_allocacmp_j_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, j_1_fu_54, ap_loop_init)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
            ap_sig_allocacmp_j <= ap_const_lv31_0;
        else 
    ...
    icmp_ln511_fu_94_p2 <= "1" when (ap_sig_allocacmp_j = empty) else "0";
