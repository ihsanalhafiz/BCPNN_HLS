...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_mul_ln482 \
    op interface \
    ports { mul_ln482 { I 63 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln485 \
    op interface \
    ports { sext_ln485 { I 62 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { Wij_stream_din { O 32 vector } Wij_stream_full_n { I 1 bit } Wij_stream_write { O 1 bit } } \
} "
}
