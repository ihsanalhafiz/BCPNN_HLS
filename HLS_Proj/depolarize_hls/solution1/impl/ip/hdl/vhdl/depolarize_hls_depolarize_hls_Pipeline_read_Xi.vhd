...
entity depolarize_hls_depolarize_hls_Pipeline_read_Xi is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of depolarize_hls_depolarize_hls_Pipeline_read_Xi is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln500_fu_98_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal i_1_fu_54 : STD_LOGIC_VECTOR (30 downto 0) := "0000000000000000000000000000000";
    signal add_ln500_fu_104_p2 : STD_LOGIC_VECTOR (30 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_i_1_load : STD_LOGIC_VECTOR (30 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal i_1_cast_fu_94_p1 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln500_fu_98_p2 = ap_const_lv1_1))) then 
                    i_1_fu_54 <= add_ln500_fu_104_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    i_1_fu_54 <= ap_const_lv31_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    Xi_stream_blk_n_assign_proc : process(ap_enable_reg_pp0_iter2, Xi_stream_full_n, ap_block_pp0_stage0)
    begin
        if (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
            Xi_stream_blk_n <= Xi_stream_full_n;
        else 
            Xi_stream_blk_n <= ap_const_logic_1;
        end if; 
    end process;

    Xi_stream_din <= gmem_addr_read_reg_137;

    Xi_stream_write_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001)
    begin
        if (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
            Xi_stream_write <= ap_const_logic_1;
        else 
            Xi_stream_write <= ap_const_logic_0;
        end if; 
    end process;

    add_ln500_fu_104_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_1_load) + unsigned(ap_const_lv31_1));
    ...
    ap_block_state3_pp0_stage0_iter2_assign_proc : process(Xi_stream_full_n)
    begin
                ap_block_state3_pp0_stage0_iter2 <= (ap_const_logic_0 = Xi_stream_full_n);
    end process;


    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln500_fu_98_p2)
    begin
        if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln500_fu_98_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone))) then 
    ...
    ap_sig_allocacmp_i_1_load_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, i_1_fu_54, ap_loop_init)
    begin
    ...
    i_1_cast_fu_94_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_1_load),32));
    icmp_ln500_fu_98_p2 <= "1" when (signed(i_1_cast_fu_94_p1) < signed(Ni)) else "0";
