...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln554 \
    op interface \
    ports { sext_ln554 { I 62 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 29 \
    name bwsup_stream_out \
    type fifo \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_bwsup_stream_out \
    op interface \
    ports { bwsup_stream_out_dout { I 32 vector } bwsup_stream_out_empty_n { I 1 bit } bwsup_stream_out_read { O 1 bit } } \
} "
}
